...
enum AppThemePalette {
  ...
  mint(
    ...
    label: '薄荷',
    description: '护眼的清新绿调',
    lightSeed: Color(0xFF00A67E),
    darkSeed: Color(0xFF5FD4A9),
    previewColor: Color(0xFF00A67E),
    darkOnly: false,
  ),
  lilac(
    key: 'lilac',
    label: '丁香紫',
    description: 'Material Design 3 优雅紫调',
  ...
  claude(
    ...
    lightSeed: Color(0xFFD97757), // 暖橙咖啡色
    darkSeed: Color(0xFFD97757),
