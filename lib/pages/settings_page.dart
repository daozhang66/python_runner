            ...
            children: [
              ...
              if (_recordRequests)
                SwitchListTile(
                  ...
                  subtitle: const Text('记录响应内容前 2 MB（增加内存占用）',
                      style: TextStyle(fontSize: 12)),
                  value: _recordResponseBody,
                  onChanged: (v) async {
                    await RequestOverrideConfig.instance
                        .setRecordResponseBody(v);
                ...
                Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      const SizedBox(height: 4),
                      const Text(
                          '覆盖 requests 等库的默认 UA（如 python-requests/2.x.x）',
          ...
          _SectionCard(
            ...
            children: [
              ListTile(
                ...
                subtitle:
                    const Text('功能说明与操作指南', style: TextStyle(fontSize: 12)),
                trailing: const Icon(Icons.chevron_right),
        ...
        children: const [
          _ManualSection(
            ...
            items: [
              ...
              _ManualItem(Icons.folder_outlined, '分组管理',
                  '点击文件夹进入分组；长按文件夹可重命名或删除，删除分组不会删除脚本'),
              ...
              _ManualItem(Icons.checklist, '多选模式', '进入多选后可批量移动、导出或删除脚本'),
              _ManualItem(Icons.push_pin, '置顶脚本', '长按脚本可置顶/取消置顶，置顶脚本始终显示在首页前方'),
              _ManualItem(
                  Icons.drag_indicator, '拖拽排序', '首页未分组普通脚本可拖拽排序；置顶脚本和文件夹不可拖动'),
          ...
          _ManualSection(
            ...
            items: [
              ...
              _ManualItem(Icons.swap_vert, '贴边收起',
                  '松手自动贴向最近屏幕边缘，仅露出 16px；3 秒后自动收起，点击或长按重新展开'),
          ...
          _ManualSection(
            ...
            items: [
              ...
              _ManualItem(Icons.bubble_chart, '悬浮球',
                  '开启后悬浮球常驻屏幕，支持贴边收起、快捷运行最近脚本、拖拽停止等'),
